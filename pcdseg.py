...
#redis-server(run in powershell)
...
def train(args):
    ...
    for epoch in range(init_epoch,args.epoch):
        ...
        print('============================2222=====================================')
        for points, target in tqdm(dataloader, total=len(dataloader), smoothing=0.9, dynamic_ncols=False, leave=False):
...
def evaluate(args):
    ...
    #a = input(r'C:\Users\M900\Downloads\PointNet12-master\PointNet12-master\checkpoints\pointnet-inview-0.52077-0018.pth')
    model = load_pointnet(args.model_name, kitti_utils.num_classes, args.pretrain) #a
